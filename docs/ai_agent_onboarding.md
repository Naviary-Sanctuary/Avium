...
- 오프라인 데이터: `assets/data/foods.v1_2_0.json`
...
dart run tool/search_quality_report.dart --input assets/data/foods.v1_2_0.json --min-top1 0.80 --min-top3 0.95
```
...
1. `assets/data/foods.v1_2_0.json` 수정
2. 필요 시 `reasonKo`, `sources`, `safetyConditions` 일관성 점검
3. 검색 토큰 재생성/검증
4. `docs/food_data_sources.md`와 `docs/source_link_audit.md` 업데이트
5. 테스트 및 분석 통과 확인
