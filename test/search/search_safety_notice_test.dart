...
void main() {
  ...
  testWidgets('hides main safety notice in search tab and supports close', (
    WidgetTester tester,
  ) async {
    ...
    final appState = AppState(
      repository: _NoticeTestRepository(),
    ...
    expect(find.text('중요 안내'), findsOneWidget);

    await tester.tap(find.byIcon(Icons.search_outlined));
    await tester.pumpAndSettle();
    expect(find.text('중요 안내'), findsNothing);

    await tester.tap(find.byIcon(Icons.home_outlined));
    await tester.pumpAndSettle();
    expect(find.text('중요 안내'), findsOneWidget);

    await tester.tap(find.byTooltip('중요 안내 닫기'));
    await tester.pumpAndSettle();
    expect(find.text('중요 안내'), findsNothing);
  });
}

class _NoticeTestRepository implements FoodRepository {
  @override
  ...
  static final FoodDb _db = FoodDb(
    ...
    foods: <FoodItem>[
      _food(id: 'foodSafe', nameKo: '호밀', level: SafetyLevel.safe),
      _food(id: 'foodDanger', nameKo: '폭파', level: SafetyLevel.danger),
    ],
  );
